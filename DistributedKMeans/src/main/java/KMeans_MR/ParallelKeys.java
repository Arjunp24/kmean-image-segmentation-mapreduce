...
public class ParallelKeys implements WritableComparable<ParallelKeys> {
  ...
  ParallelKeys(int key, int centroid) {
    this.key = key;
   ...
   */
  @Override
  public int compareTo(ParallelKeys p) {
    return Integer.compare(this.key, p.getKey());
  }

  @Override
  public void write(DataOutput dataOutput) throws IOException {
//    dataOutput.write(key);
//    dataOutput.write(centroid);
  }

  @Override
  public void readFields(DataInput dataInput) throws IOException {
//    key = dataInput.readInt();
//    centroid = dataInput.readInt();
  }

  @Override
  public String toString(){
    return this.key+", "+this.centroid;
  }
